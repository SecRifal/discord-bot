...
- `/ill_edit` - редактировать impossible level
  Параметры:
  - level_id: str (ID уровня для редактирования)
  - position: int (новая позиция, опционально)
  - name: str (новое название, опционально)
  - creator: str (новый создатель, опционально)
  - video_url: str (новая ссылка на видео, опционально)
  - img: файл (новое изображение, опционально)

- `/ill_delete` - удалить impossible level
  Параметры:
  - level_id: str (ID уровня для удаления)
